...
particular feature into Gokumo.
...
However, Gokumo comes with minimal set of kernel drivers enabled, if you are sure that your hardware
...
```bash
   ...
   git clone git@github.com:<your username>/gokumo.git
   # navigate to the newly cloned directory
   cd Gokumo
   # assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/gokumo/gokumo.git
   ```
...
[issue]: https://github.com/gokumo/gokumo/issues
[similar issue]: https://github.com/gokumo/gokumo/search?&ref=cmdform&type=Issues
