...
PKG_DEPENDS_TARGET="toolchain alsa-lib freetype zlib retroarch-assets retroarch-overlays core-info core-dependencies retroarch-joypad-autoconfig gokumo-update libretro-database ffmpeg libass libvdpau libxkbfile xkeyboard-config libxkbcommon joyutils sixpair glsl-shaders empty"
...
if [ "$VULKAN" == "mesa" ]; then
  RETROARCH_GL="--enable-vulkan --enable-kms"
...
make_target() {
  if [ "${BUILD_WITH_DEBUG}" = "yes" ]; then
    make DEBUG=1 V=1 HAVE_LAKKA=1 HAVE_ZARCH=0
  else
